		...
		<>
			...
			<Auth>
				<div className='bg-white border flex flex-col gap-2 p-4 pt-10 drop-shadow-md'>
					...
					<p className='mx-auto text-slate-400 font-bold text-lg max-w-xs text-center	'>Đăng nhập .</p>
					{/*<div className="bg-white border flex flex-col gap-2 p-4 pt-10 drop-shadow-md">*/}
					{/*  <LazyLoadImage*/}
					{/*    draggable="false"*/}
					...
					{/*    alt="logo"*/}
					{/*  />*/}
					<form onSubmit={formik.handleSubmit} className='flex flex-col justify-center items-center gap-3 m-3 md:m-8'>
						<TextField
							fullWidth
							label='Email'
							name='email'
						...
						<FormControl
							...
							{formik.errors.password && formik.touched.password ? (
								<FormHelperText style={{ color: '#d32f2f' }}>{formik.errors.password}</FormHelperText>
							) : null}
						</FormControl>
